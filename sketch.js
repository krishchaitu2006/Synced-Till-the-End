...
var levelBonus1,levelBonus1Img;
var startBtn6;
var msg6,msg6Img;
...
function preload(){
  ...
  levelBonus1Img = loadImage("slideInf.jpg");
  msg6Img = loadImage("msg6.jpg");
...
function setup (){
  ...
  logo = createSprite(300,70,600,400);
  ...
  inst = createSprite(-300,100,100,50);
  inst.addImage("instructions",instImg);
  inst.scale = 0.7;
  //inst.debug = true;
  ...
  startBtn6 = createSprite(1770,300,100,50);
  startBtn6.addImage("start",startBtnImg);
  startBtn6.scale = 0.6;
  ...
  msg2.addImage("msg2",msg2Img);
  msg2.scale = 0.85;
  msg2.visible = false;
  
  msg3 = createSprite(300,200,50,100);
  msg3.addImage("msg3",msg3Img);
  msg3.scale = 0.85;
  msg3.visible = false;
  
  msg4 = createSprite(300,200,50,100);
  msg4.addImage("msg4",msg4Img);
  msg4.scale = 0.85;
  msg4.visible = false;
  
  msg5 = createSprite(300,200,50,100);
  msg5.addImage("msg5",msg5Img);
  msg5.scale = 0.85;
  msg5.visible = false;

  msg6 = createSprite(300,-1350,50,100);
  msg6.addImage("msg6",msg6Img);
  msg6.scale = 0.85;
  msg6.visible = false;
...
/////////////////////////How to play Button//////////////////
  ...
  fill("red");
  text("*Read the instructions in",0,20);
  text("how to play option",5,35);
  text("Before playing",5,50);
